...
if(isset($_POST['create'])) {
    if (empty($_POST['UserName'])){
        ...
        if (!preg_match("/^[a-zA-Z-' ]*$/",$name)) {
            $error = "Chỉ cho phép các chữ cái và khoảng trắng";
        }
    }
    ...
    if(empty($_POST['PassWord']))
    {
        ...
        if (strlen($_POST ["PassWord"]) < 5) {
            $pass_error = "Mhat khau qua ngan";
        }
        else
        {
            $pass_error = test_input($_POST["PassWord"]);
        }
    }
}
...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container">
                <form action="" method="post" enctype="multipart/form-data" id="form_create"">
                <label for="Name">User Name:</label><br>
                <input type="text" id="name" name="UserName" value="" ><br/>
                <?php echo isset($error)?$error:''; echo "\n"?>
                <br/>
                ...
                <br/>
                <input type="submit" id="btn_create" value="Create" name="create" class="btn btn-success">
                <div>
                    <a href="../view/ManageUser.php">Danh Sách User</a>
                </div>
                </form>
            </div>
        </div>
